...
<!--<h2 class="dash-header-text"> Staff Dashboard</h2>-->
	<div class="dashboard-container">
		<div class="side-bar-left-container">
			<ul>
		<li><a href="StaffViewAppointment.php"  class="dash-text-left"><img src="icon/checked.png" class="dash-icon-display">Confirm Appointment</a></li>
		<li><a href="UpdateRecord.php" class="dash-text-left" ><img src="icon/test.png" class="dash-icon-display">Manage Students Record</a></li>
		<li><a href="VerifyHistory.php" class="dash-text-left"><img src="icon/professor.png" class="dash-icon-display">Verify Medical History</a></li>
		<li><a href="Next.php" class="dash-text-left"><img src="icon/user-40.png" class="dash-icon-display">Next Student</a></li>
		<li><a href="Sms.php" class="dash-text-left"><img src="icon/emails.png" class="dash-icon-display">SMS Reminder</a></li>
		<li><a href="StaffProfileEdit.php" class="dash-text-left"><img src="icon/edit.png" class="dash-icon-display">Change Password</a></li>
		...
		<div class="side-bar-right-container">
			...
			<a href="StaffViewAppointment.php">
			...
			<div class="inside-bar-container">
				<img src="icon/test.png" class="inside-icon-display">
				<p class="link-list-txt">Manage Record</p>
			</div>
			</a>
			<a href="Sms.php">
			<div class="inside-bar-container">
