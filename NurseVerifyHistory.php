...
<form action="NurseVerifyHistory.php" method="POST">
...
<a href="NurseHome.php"><input style="margin-left:20px; margin-top:20px;" type='submit' name='back' class='btn btn-danger' value='<< CANCEL'/></a>
</div>
