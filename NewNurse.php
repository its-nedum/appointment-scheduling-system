...
if(isset($submit)){
	...
	mysql_query("INSERT INTO nurse(surname,first_name,unit,phone,email,username,password)
		VALUES('$surname','$firstname','$unit','$phone','$email','$username','$password')");

	echo "<script>alert('A new nurse have been successfully registered');</script>";
...
<div class="panel-heading" style="background:darkblue;"><h3>Add New Nurse</h3></div>
	...
	<div class="row">
		...
		<div class="col-xs-4"> </div>
			...
			<div class="col-xs-4">
				...
				<div class="cover">
				<form method="POST" action="NewNurse.php">
					<div class="row">
					...
					<div class="row">
						<div class="form-group col-xs-6">
							Unit:<select name="unit" required="required" class="form-control input-sm">
			...
			<div class="row">
			<center>
			<marquee behavior="alternate"> <a href="NewStaff.php">Click here to register a Doctor</a> </marquee>
			</center>
			</div>
			</div>
			</div>
