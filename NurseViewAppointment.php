...
<head>
	...
	<script>
		...
		if(test == true) {	
		document.frmUser.action = "NurseViewAppointmentProcess.php";
		...
		if(test == true) {
		document.frmUser.action = "NurseViewAppointmentProcess2.php";
		document.frmUser.submit();
		}
}
...
echo "<ul class='pager'>";
if(!($pagenum<=1)){
	echo " <li> <a href='NurseViewAppointment.php?pagenum=$prev'>&larr; Prev</a> </li>";
	}
	...
	if(!($pagenum>=$lastpage)){
	echo "<li> <a href='NurseViewAppointment.php?pagenum=$next'>Next &rarr;</a> </li>";
	}
	echo "</ul>";
}else{
...
<div class="row">
	<div class="col-xs-4" style="margin-left:30px;">
		<a href="NurseHome.php"><input type="submit" name="back" class="btn btn-primary" value="BACK"/></a>
