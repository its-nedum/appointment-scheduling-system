...
$query = "SELECT * FROM nurse WHERE username = '$myown' ";
...
@$change = $_POST['change'];
if(isset($change)){
	$queryme = "UPDATE nurse SET username = '$username', password = '$password' WHERE surname = '$sur' ";
...
<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		<div class="col-xs-4">
		<form action="NurseProfileEdit.php" method="POST">
				...
				<center><a href="NurseHome.php" class="btn btn-danger"><< BACK</a>
